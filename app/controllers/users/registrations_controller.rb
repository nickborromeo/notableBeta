  ...
  private
    def makeDefaultNotebook
      ...
      if @default_notebook.save
        ...
        makeDefaultNotes(notebook_id)
      end
    end

    def makeDefaultNotes(notebook_id)
      ...
      note3 = { "guid"=> SecureRandom.uuid, "subtitle"=>"", "fresh"=>true, "notebook_id"=>notebook_id,
        "title"=>"To get started, create some new notes by click the [+] button on the top left corner or just press \"enter\" within any note", "rank"=>1, "depth"=>2, "collapsed"=>false, "parent_id"=>"root" }
      ...
      note18 = { "guid"=> SecureRandom.uuid, "subtitle"=>"", "fresh"=>true, "notebook_id"=>notebook_id,
        "title"=>"You create new notebooks just like creating new notes.  First give your notebook a name, and use the [+] button or just press \"enter\"", "rank"=>1, "depth"=>2, "collapsed"=>false, "parent_id"=>"root" }
      ...
      note40 = { "guid"=> SecureRandom.uuid, "subtitle"=>"", "fresh"=>true, "notebook_id"=>notebook_id,
        "title"=>"<b>Bonus Level</b> - Congratulations on reading all the way to the end! As a reward, we would like to present you with some bonus features for advanced users. (Use ctrl+down to reveal)", "rank"=>4, "depth"=>1, "collapsed"=>true, "parent_id"=>"root" }
