...
#         depth: @testerNOTE2.get('depth')
#         rank: @testerNOTE2.get('rank')
#         parent_id: @testerNOTE2.get('parent_id')
        
#       Given -> App.Action.addHistory 'moveNote', @tester2NOTE
#       Given -> @tree1.dropBefore @testerNOTE2, @tree1.findNote('11369365-3436-4e15-b8e2-2aa20b5f915e')
...
#       Then -> expect( @testerNOTE2.get('parent_id') ).toEqual(@tester2New['parent_id'])
...
#         describe "undo 'moveNote' and change values on the correct tree.", ->
#           Then -> expect( @testerNOTE2.get('rank') ).toEqual(@tester2Previous['rank'])
            
#         describe "redo 'moveNote' and change value on the tree", ->
#           When -> App.Action.redo(@tree1) # redo tester2
#           Then -> expect( @testerNOTE2.get('rank') ).toEqual(@tester2New['rank'])
...
#             When -> @tree1.tabNote @tester3NOTE
...
#             When -> @tree1.unTabNote @tester3NOTE
#             Then -> expect( App.Action._getActionHistory().length ).toEqual(3)
#             And -> expect(App.Action._getActionHistory()[2]['type']).toEqual('moveNote')
