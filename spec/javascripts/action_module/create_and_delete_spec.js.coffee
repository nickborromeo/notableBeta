...
# 			When -> App.Action.undo() #delete Note 3
# 			When -> App.Action.undo() #delete Note 2
# 			When -> App.Action.undo() #delete Note 1 ?????*****************
...
# 				And -> expect(App.Action._getUndoneHistory()[0]['changes']['ancestorNote']['guid']).toEqual(@tester1GUID)
