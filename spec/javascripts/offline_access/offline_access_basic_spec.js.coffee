...
@Notable.module("OfflineAccess", (OfflineAccess, App, Backbone, Marionette, $, _) ->
  ...
  #   Given -> @localStore = JSON.parse window.localStorage.getItem('unsyncedChanges')
  ...
  # this test is broken because checkAndLoadLocal calls fetch on all notes
  # a long number of hours spent on this tells me its not terribly important
